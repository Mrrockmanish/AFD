...
(() => {
  var e, t = {
    968: (e, t, n) => {
      "use strict";
      var i, o = n(755), a = n.n(o);
      n(729), a()(".li-dropdown").on("click", (function () {
        a()(this).find(".li-dropdown__ul").fadeToggle(), a()(document).mouseup((function (e) {
          var t = a()(".li-dropdown");
          t.is(e.target) || 0 !== t.has(e.target).length || t.find(".li-dropdown__ul").fadeOut()
        }))
      })), a()(".filers-switch").on("click", (function () {
        a()(".filters-block").fadeToggle()
      })), a()(".filters-button").on("click", (function () {
        a()(".filters-block").fadeOut()
      })), i = a()(".afd-gallery "), i.each((function () {
        a()(this).magnificPopup({delegate: ".afd-gallery__item a", type: "image", gallery: {enabled: !0}})
      })), a()(".open-block").on("click", ".open-block__caption", (function () {
        var e = a()(this).closest(".open-block");
        e.toggleClass("open"), e.hasClass("open") ? e.find(".open-block__content").fadeIn() : e.find(".open-block__content").fadeOut()
      }))
    }, 729: (e, t, n) => {
      var i, o, a;
      o = [n(755)], i = function (e) {
        var t, n, i, o, a, r, s = "Close", l = "BeforeClose", c = "MarkupParse", d = "Open", p = "Change", u = "mfp", f = ".mfp", m = "mfp-ready", g = "mfp-removing", v = "mfp-prevent-close", h = function () {
        }, C = !!window.jQuery, y = e(window), b = function (e, n) {
          t.ev.on(u + e + f, n)
        }, w = function (t, n, i, o) {
        ...
        h.prototype = {
          constructor: h, init: function () {
            ...
            if (!1 === n.isObj) {
              ...
              var r, s = n.items;
              for (o = 0; o < s.length; o++) if ((r = s[o]).parsed && (r = r.el[0]), r === n.el[0]) {
                t.index = o;
                break
              }
            } else t.items = e.isArray(n.items) ? n.items : [n.items], t.index = n.index || 0;
            if (!t.isOpen) {
              t.types = [], a = "", n.mainEl && n.mainEl.length ? t.ev = n.mainEl.eq(0) : t.ev = i, n.key ? (t.popupsCache[n.key] || (t.popupsCache[n.key] = {}), t.currTemplate = t.popupsCache[n.key]) : t.currTemplate = {}, t.st = e.extend(!0, {}, e.magnificPopup.defaults, n), t.fixedContentPos = "auto" === t.st.fixedContentPos ? !t.probablyMobile : t.st.fixedContentPos, t.st.modal && (t.st.closeOnContentClick = !1, t.st.closeOnBgClick = !1, t.st.showCloseBtn = !1, t.st.enableEscapeKey = !1), t.bgOverlay || (t.bgOverlay = w("bg").on("click.mfp", (function () {
                t.close()
              })), t.wrap = w("wrap").attr("tabindex", -1).on("click.mfp", (function (e) {
              ...
              I("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (b(c, (function (e, t, n, i) {
                n.close_replaceWith = x(i.type)
              })), a += " mfp-close-btn-in") : t.wrap.append(x())), t.st.alignTop && (a += " mfp-align-top"), t.fixedContentPos ? t.wrap.css({overflow: t.st.overflowY, overflowX: "hidden", overflowY: t.st.overflowY}) : t.wrap.css({
                top: y.scrollTop(),
                position: "absolute"
              }), (!1 === t.st.fixedBgPos || "auto" === t.st.fixedBgPos && !t.fixedContentPos) && t.bgOverlay.css({height: i.height(), position: "absolute"}), t.st.enableEscapeKey && i.on("keyup.mfp", (function (e) {
              ...
              return t.isIE7 && (v += " mfp-ie7"), v && t._addClassToMFP(v), t.updateItemHTML(), I("BuildControls"), e("html").css(f), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout((function () {
                t.content ? (t._addClassToMFP(m), t._setFocus()) : t.bgOverlay.addClass(m), i.on("focusin.mfp", t._onFocusIn)
            ...
            t.appendContent(r, i), n.preloaded = !0, I(p, n), o = n.type, t.container.prepend(t.contentContainer), I("AfterChange")
            ...
            i.data && (n = e.extend(i.data, n)), I(c, [t, n, i]), e.each(n, (function (n, i) {
              ...
              if ((o = n.split("_")).length > 1) {
                ...
                if (a.length > 0) {
                  var r = o[1];
                  "replaceWith" === r ? a[0] !== i[0] && a.replaceWith(i) : "img" === r ? a.is("img") ? a.attr("src", i) : a.replaceWith(e("<img>").attr("src", i).attr("class", a.attr("class"))) : a.attr(o[1], i)
                }
          ...
          if ("string" == typeof n) if ("open" === n) {
            var o, a = C ? i.data("magnificPopup") : i[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
        ...
        var _, T, O, P = "inline", S = function () {
          O && (T.after(O.addClass(_)).detach(), O = null)
        };
        e.magnificPopup.registerModule(P, {
          options: {hiddenClass: "hide", markup: "", tNotFound: "Content not found"}, proto: {
            initInline: function () {
              t.types.push(P), b("Close.inline", (function () {
                S()
              }))
              ...
              if (S(), n.src) {
                ...
                if (a.length) {
                  ...
                  r && r.tagName && (T || (_ = o.hiddenClass, T = w(_), _ = "mfp-" + _), O = a.after(T).detach().removeClass(_)), t.updateStatus("ready")
        ...
        e.magnificPopup.registerModule(z, {
          options: {settings: null, cursor: "mfp-ajax-cur", tError: '<a href="%url%">The content</a> could not be loaded.'}, proto: {
            initAjax: function () {
              t.types.push(z), E = t.st.ajax.cursor, b("Close.ajax", B), b("BeforeChange.ajax", B)
            }, getAjax: function (n) {
          ...
          options: {
            ...
            initImage: function () {
              ...
              t.types.push("image"), b("Open.image", (function () {
                ...
                n.cursor && e(document.body).removeClass(n.cursor), y.off("resize.mfp")
              ...
              var n = 0, i = e.img[0], o = function (a) {
              ...
              var o = 0, a = function () {
                n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, I("ImageLoadComplete")) : ++o < 200 ? setTimeout(a, 100) : r())
              }, r = function () {
          ...
          options: {
            ...
            initZoom: function () {
              ...
              if (n.enabled && t.supportsTransition) {
                var o, a, r = n.duration, s = function (e) {
                  var t = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"), i = "all " + n.duration / 1e3 + "s " + n.easing, o = {position: "fixed", zIndex: 9999, left: 0, top: 0, "-webkit-backface-visibility": "hidden"}, a = "transition";
        ...
        e.magnificPopup.registerModule(F, {
          options: {
            ...
            initIframe: function () {
              t.types.push(F), b("BeforeChange", (function (e, t, n) {
                t !== n && (t === F ? j() : n === F && j(!0))
        ...
        e.magnificPopup.registerModule("gallery", {
          options: {enabled: !1, arrowMarkup: '<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>', preload: [0, 2], navigateByImgClick: !0, arrows: !0, tPrev: "Previous (Left arrow key)", tNext: "Next (Right arrow key)", tCounter: "%curr% of %total%"}, proto: {
            initGallery: function () {
              ...
              })), b(c + o, (function (e, i, o, a) {
                var r = t.items.length;
                o.counter = r > 1 ? W(n.tCounter, a.index, r) : ""
              })), b("BuildControls" + o, (function () {
                if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                  var i = n.arrowMarkup, o = t.arrowLeft = e(i.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(v), a = t.arrowRight = e(i.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(v);
                  o.click((function () {
                    t.prev()
                  })), a.click((function () {
                    t.next()
      ...
      }, void 0 === (a = i.apply(t, o)) || (e.exports = a)
    }
  }, n = {};
  ...
  i.m = t, e = [], i.O = (t, n, o, a) => {
    if (!n) {
      ...
      for (d = 0; d < e.length; d++) {
        for (var [n, o, a] = e[d], s = !0, l = 0; l < n.length; l++) (!1 & a || r >= a) && Object.keys(i.O).every((e => i.O[e](n[l]))) ? n.splice(l--, 1) : (s = !1, a < r && (r = a));
        if (s) {
          e.splice(d--, 1);
          var c = o();
          void 0 !== c && (t = c)
    ...
    var t = (t, n) => {
      ...
      for (t && t(n); c < r.length; c++) a = r[c], i.o(e, a) && e[a] && e[a][0](), e[r[c]] = 0;
      return i.O(d)
    }, n = self.webpackChunkwebpack_template = self.webpackChunkwebpack_template || [];
    n.forEach(t.bind(null, 0)), n.push = t.bind(null, n.push.bind(n))
  })();
  var o = i.O(void 0, [755], (() => i(968)));
  o = i.O(o)
})();
